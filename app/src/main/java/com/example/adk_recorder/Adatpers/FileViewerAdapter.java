package com.example.adk_recorder.Adatpers;
...
import com.example.adk_recorder.Fragments.PlaybackFragment;
...
public class FileViewerAdapter extends RecyclerView.Adapter<FileViewerAdapter.FileViewerViewHolder> implements OnDatabaseChangeListener {
    ...
    public void onBindViewHolder(@NonNull FileViewerViewHolder holder, int i) {
        ...
        int minutes = (int) ((recordingItem.getLength())/60000);
        int seconds = (int) ((recordingItem.getLength())/1000 - (minutes)*60);

        //long minutes = TimeUnit.MILLISECONDS.toMinutes(recordingItem.getLength());
        //long seconds = TimeUnit.MICROSECONDS.toSeconds(recordingItem.getLength()) - TimeUnit.MINUTES.toSeconds(minutes);
